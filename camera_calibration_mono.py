...
class calibration_intrinsic:
    def __init__(self,charuco_board,image_topic):
        ...
        self.images = 0                                     # Number of images
        self.calibration= 0                                 # Calibration success flag 
        self.cameraMatrix= None                             # Camera Matrix
        self.distCoeffs = None                              # Distortion Coefficient
        self.image_topic = image_topic                      # ROS image topic
        self.charuco_board = charuco_board                  # Charuco board object
        self.sub = None                                     # rospy subscriber 
        self.objpts=[]                                      # object points
    ...
    # Calibrate camera on collected images
    def calibrate(self):
